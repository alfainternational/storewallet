...
class UserAPIController extends Controller
{
     ...
     * @return void
     */
    public function __construct(UserRepository $userRepository, UploadRepository $uploadRepository, RoleRepository $roleRepository, CustomFieldRepository $customFieldRepo, WalletService $walletService)
    {
    ...
    function register(Request $request)
    {
        try {
            ...
            try {
                $walletUser = $this->walletService->createWalletUser($request->all());
                if ($walletUser) {
